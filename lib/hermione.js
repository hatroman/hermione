...
module.exports = class Hermione extends PassthroughEmitter {
    ...
    run(testPaths, options) {
        ...
        this.passthroughEvent(runner, _.values(RunnerEvents.getAll()));
        this.passthroughEvent(signalHandler, RunnerEvents.EXIT);
    ...
    readTests(testPaths, browsers) {
        ...
        const runner = Runner.create(this._config);
        this.passthroughEvent(runner, _.values(RunnerEvents.getSync()));
